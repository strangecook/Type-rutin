...
import { faHome, faCalendarCheck, faSadCry } from "@fortawesome/free-solid-svg-icons";
    ...
    <SideBarComponent sideState={sideState}>
      <div className="sidebarcover">
        ...
        <div onClick={goToLeftWorksPage} className="untodoList">
          <FontAwesomeIcon className='todolistIcon' icon={faSadCry} size="3x"></FontAwesomeIcon>
